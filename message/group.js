...
Hai @${anj.participants[0].split("@")[0]} sayang, selamat datang di Grup ${groupName} , Budayakan baca deskripsi ya`
...
Babay @${anj.participants[0].split("@")[0]} 👋 selamat kluar  , ayam goyengku mana?`, contextInfo: {"mentionedJid": [anj.participants[0]]}})
