...
const start = async(sesion) => {
    ...
    // MENG WE EM
    console.log(color(figlet.textSync('mriyamnn', {
		font: 'Bloody',
	...
	console.log(biocolor(`=>  Bot creator by mriyamnn`))
	console.log(biocolor(`=>  Wa : 089649627900`))
	console.log(biocolor(`=>  Ig : mriyamnn`))
	console.log(biocolor(`=>  Wl : miror`))
	console.log(biocolor(`=>  Ayam goyeng!!!`))		
    ...
    // Konek
    xinz.on('open', (json) => {
		console.log(XinzLog('Yeay berhasil tersambung!'))
	})
    ...
    // Ya gitulah
    xinz.on('ws-close', () => {
        console.log(XinzLog('Udahan ya sayang kita putus jangan rindu'))
    })
 ...
 */
 function nocache(module, cb = () => { }) {
    console.log(color(`Module ${module} mriyamnn selalu mengawasi`))
