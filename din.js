...
// Fake Yutube        
        ...
        "vcard": "BEGIN:VCARD\nVERSION:3.0\nN:mriyamnn\nFN:mriyamnn\nORG:m r i y a m n n\nTITLE:\nitem1.TEL;waid=6289649627900\nitem1.X-ABLabel:Telepon\nX-WA-BIZ-DESCRIPTION:Ada ayam goyeng?\nX-WA-BIZ-NAME:mriyamnn\nEND:VCARD"
        }
        
//Ucapan Waktunya sayang
       ...
       // Auto Read
        ...
        switch (command){   
             ...
             case prefix+'menubot':{             
                ...
                var pic = 'https://telegra.ph/file/d57333ed19dd19d04eecf.jpg'
            }
            ...
            case prefix+'report':
                ...
                case prefix+'botpatnert':{
                    ...
                    xinz.sendMessage(from, { contacts: arrey }, MessageType.contactsArray, {quoted: msg })
                                    .then((res) => xinz.sendMessage(from, 'Patnert Yan - Bot >_<', text, {quoted: res}))
              ...
              case 'assalamualaikum':{
                    textImg(`waalaikumsalam sayang ${pushname}`)
                    }
              break 
              case prefix+'menu':
              case prefix+'help':{  
        ...
        break     
            ...
            case prefix + 'qrcode':
                ...
                reply(mess.wait)
                   ...
                   .then( res => {
                xinz.sendMessage(from, res, image, { quoted: msg, caption: `nih sayang`})
                   })
            break 
            case prefix + 'amongus': {
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply(`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
           ...
           case prefix+'imgtourl':{
            ...
            case prefix+'nulis':{
                ...
                reply(mess.wait)
                sendFileFromUrl(from, `https://api.zeks.xyz/api/nulis?apikey=apivinz&text=${q}`, 'Jangan mager sayang:v', msg)
           ...
           case prefix + 'foliokiri': {
            ...
            case prefix + 'cekbapak': // By Ramlan ID
                const bapak = ['Wah Mantap Lu Masih Punya Bapack\nPasti Bapack Nya Kuli :v\nAwowkwokwwok\n#CandabOs', 'Aowkwwo Disini Ada Yteam :v\nLu Yteam Bro? Awowkwowk\nSabar Bro Ga Punya Bapack\n#Camda', 'Bjir Bapack Mu Ternyata Sudah Cemrai\nSedih Bro Gua Liatnya\nTapi Nih Tapi :v\nTetep Ae Lu Yteam Aowkwowkw Ngasayang :v', 'Jangan #cekbapak Mulu Broo :v\nKasian Yang Yteam\nNtar Tersinggung Kan\nYahahaha Hayyuk By : Ramlan ID']
           ...
           case prefix+'fakehidetag':{
            ...
            case prefix+'fitnah':
                ...
                break 
            case prefix+'beban':{
                textImg(`Jangan gitu sayang kasian dia di hina mulu, kalau jadi gue sih sama tak hina`)
                }
            break
            ...
            case prefix+ 'creator':
            case prefix + 'owner':{
            xinz.sendContact(from, `${ownerNumber}`, `${ownerName}`)
               }
            break
            case prefix + 'igowner':
            case prefix + 'instagramowner':{
                 textImg(`follow instagram owner https://www.instagram.com/mriyamnn/`)
                 }
            break
            ...
            case prefix+'sourcecode':
                 textImg(`Script bot ini dijual denga harga 30k, mahal? Ya iyalah ini susah di buatnya ngotak sikit 😡`)
                 break    
            case prefix + 'ping':
            case prefix + 'speed': {
                let timestamp = speed();
...
*Runtime :* ${runtime(anu)}`
               ...
               let totalchat = await xinz.chats.all()
                ...
                const { wa_version, mcc, mnc, os_version, device_manufacturer, device_model } = xinz.user.phone
                let anu = process.uptime()
                let caption = `Creator by mriyamnn`
      ...
      case prefix+'update':
            ...
            case prefix + 'bcbuton':
                ...
                let bctext =`\n\n• *${botName}* Broadc •`
                    ...
                    let media = await xinz.downloadMediaMessage(encmedia)
                    for (let i of chiit) {                   
                        sendButImage(i.jid, `*YAN-BOT BROADCAST*`, `• Not : ${q}`, media, hedehbre, {quoted: fakeTroli, contextInfo:{mentionedJid: parseMention(q) }})
                    }
                    reply(`Sukses`)
                    ...
                    let media = await xinz.downloadMediaMessage(encmedia)
                    for (let i of chiit) {
                        sendButVideo(i.jid, `*YAN-BOT BROADCAST*`, `• Not : ${q}`, video, hedehbre, {quoted: fakeTroli, contextInfo: { mentionedJid: parseMention(q) }})
                    }
                    reply(`Sukses`)
                } else {
                    for (let i of chiit) {
